$(document).ready(function(){
 ...
 // COLECCIONES ===============================================
  ...
  var ColeccionShopping = new CamaraColeccion();
    ColeccionShopping.url = 'getCamaras/Shopping';
  var ColeccionHipercentro = new CamaraColeccion();
    ColeccionHipercentro.url = 'getCamaras/Hipercentro';
  var ColeccionPlaza = new CamaraColeccion();
    ColeccionPlaza.url = 'getCamaras/Plaza';
  var ColeccionNorte = new CamaraColeccion();
    ColeccionNorte.url = 'getCamaras/Norte';
